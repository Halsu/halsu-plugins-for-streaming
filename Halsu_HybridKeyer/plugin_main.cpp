...
void video_render(void *data, gs_effect_t *effect)
{
    ...
    float Spill_Tint_Intensity_norm = (s->Spill_Tint_Intensity - -100.00000f) / (100.00000f - -100.00000f);
    ...
    float Spill_unpremultiply_norm = (s->Spill_unpremultiply - -100.00000f) / (100.00000f - -100.00000f);
    ...
    float Premultiply_norm = (s->Premultiply - -100.00000f) / (100.00000f - -100.00000f);
    ...
    float Soft_Unpremultiply_norm = (s->Soft_Unpremultiply - -100.00000f) / (100.00000f - -100.00000f);
...
obs_properties_t *get_properties(void *data)
{
    ...
    obs_properties_add_float_slider(props, "Spill_Tint_Intensity", "Spill Tint Intensity", -100.0, 100.0, 0.01);
    obs_properties_add_float_slider(props, "Spill_unpremultiply", "Spill unpremultiply", -100.0, 100.0, 0.01);
    obs_properties_add_float_slider(props, "Premultiply", "Premultiply", -100.0, 100.0, 0.01);
    obs_properties_add_float_slider(props, "Soft_Unpremultiply", "Soft Unpremultiply", -100.0, 100.0, 0.01);
