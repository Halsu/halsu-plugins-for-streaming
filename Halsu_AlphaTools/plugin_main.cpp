...
void video_render(void *data, gs_effect_t *effect)
{
    ...
    // Bind Uniforms
        gs_effect_set_int(gs_effect_get_param_by_name(s->effect, "Tool_Mode"), s->Tool_Mode);
    float Alpha_Expansion_norm = (s->Alpha_Expansion - 0.00000f) / (100.00000f - 0.00000f);
    float Alpha_Expansion_final = Alpha_Expansion_norm * (1000.00000f - -1000.00000f) + -1000.00000f;
    gs_effect_set_float(gs_effect_get_param_by_name(s->effect, "Alpha_Expansion"), Alpha_Expansion_final);
    float Alpha_Blur_norm = (s->Alpha_Blur - 0.00000f) / (100.00000f - 0.00000f);
    float Alpha_Blur_final = Alpha_Blur_norm * (1000.00000f - -1000.00000f) + -1000.00000f;
    gs_effect_set_float(gs_effect_get_param_by_name(s->effect, "Alpha_Blur"), Alpha_Blur_final);
    float Median_Alpha_norm = (s->Median_Alpha - 0.00000f) / (100.00000f - 0.00000f);
    float Median_Alpha_final = Median_Alpha_norm * (1000.00000f - -1000.00000f) + -1000.00000f;
    gs_effect_set_float(gs_effect_get_param_by_name(s->effect, "Median_Alpha"), Median_Alpha_final);
    gs_effect_set_bool(gs_effect_get_param_by_name(s->effect, "Unpremultiply"), s->Unpremultiply);
    float Matte_offset_x_norm = (s->Matte_offset_x - 0.00000f) / (100.00000f - 0.00000f);
    float Matte_offset_x_final = Matte_offset_x_norm * (1000.00000f - -1000.00000f) + -1000.00000f;
    gs_effect_set_float(gs_effect_get_param_by_name(s->effect, "Matte_offset_x"), Matte_offset_x_final);
    float Matte_offset_y_norm = (s->Matte_offset_y - 0.00000f) / (100.00000f - 0.00000f);
    float Matte_offset_y_final = Matte_offset_y_norm * (1000.00000f - -1000.00000f) + -1000.00000f;
    gs_effect_set_float(gs_effect_get_param_by_name(s->effect, "Matte_offset_y"), Matte_offset_y_final);
    gs_effect_set_bool(gs_effect_get_param_by_name(s->effect, "Preview_Alpha"), s->Preview_Alpha);
...
obs_properties_t *get_properties(void *data)
{
    ...
    obs_property_t *p_Tool_Mode = obs_properties_add_list(props, "Tool_Mode", "Tool Mode", OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
    ...
    obs_properties_add_float_slider(props, "Alpha_Expansion", "Alpha Expansion", 0.0, 100.0, 0.01);
    obs_properties_add_float_slider(props, "Alpha_Blur", "Alpha Blur", 0.0, 100.0, 0.1);
    obs_properties_add_float_slider(props, "Median_Alpha", "Median Alpha", 0.0, 100.0, 0.1);
    obs_properties_add_bool(props, "Unpremultiply", "Unpremultiply");
    obs_properties_add_float_slider(props, "Matte_offset_x", "Matte offset x", 0.0, 100.0, 1.0);
    obs_properties_add_float_slider(props, "Matte_offset_y", "Matte offset y", 0.0, 100.0, 1.0);
